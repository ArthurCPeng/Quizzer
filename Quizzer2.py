...
boxes = ["First Generation (Non-Selective)","Second Generation (Cardiac-Selective)",
         "Third Generation (Beta Blockers with Vasodilator Effects)","Beta Blockers with Sympathomimetic Activity"]
items = ["propranolol","metoprolol","bisoprolol","labetalol","carvedilol",
         "nebivolol","pindolol","acebutalol"]

answer = {}
answer.setdefault(items[0],boxes[0])

answer.setdefault(items[1],boxes[1])
answer.setdefault(items[2],boxes[1])

answer.setdefault(items[3],boxes[2])
answer.setdefault(items[4],boxes[2])
answer.setdefault(items[5],boxes[2])

answer.setdefault(items[6],boxes[3])
answer.setdefault(items[7],boxes[3])
