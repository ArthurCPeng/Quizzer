...
#Define box class
class Box():
    def __init__(self, text, box_image, text_position_x, text_position_y, font_value):
        super().__init__()
        self.text = text
        ...
        for line in lines:
            ...
            text_image = font.render(line, True, (255,0,0))
            
            text_position = text_image.get_rect()
            text_height = text_position.bottom - text_position.top
            
            text_position.center = text_position_x, text_position_y
            text_position.top = text_position_y - (len(lines)/2 - line_number) * text_height - (len(lines)/2 - line_number - 0.5) * line_margin
        ...
        self.box_position.center = text_position_x, text_position_y
...
def reset_all_boxes(all_boxes):
    ...
    for boxes in all_boxes:
        ...
        this_font_value = all_font_values[all_boxes.index(boxes)]
        ...
        for box in boxes:
            ...
            new_box = Box(box,box_image,box_position.center[0],box_position.center[1], this_font_value)
