...
for box in boxes:
    ...
    box_text_position.center = box_position.center
    
    print(type(box))
    print(type(box_image))
    print(type(box_position.center[0]))
    print(type(box_position.center[1]))
    '''
    ...
    #blit the boxes and the text     
    #screen.blit(box_image, box_position)
    #screen.blit(box_test, box_position)
...
for item in items:
    item_position.center = random.randint(item_width,screen_width-item_width), random.randint(total_height,screen_height - item_height)
